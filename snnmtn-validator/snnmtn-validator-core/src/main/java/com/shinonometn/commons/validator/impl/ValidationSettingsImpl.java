package com.shinonometn.commons.validator.impl;


import com.shinonometn.commons.validator.FieldValidator;
import com.shinonometn.commons.validator.ValidationMeta;
import com.shinonometn.commons.validator.ValidationMetaBuilder;
import com.shinonometn.commons.validator.model.KeyValue;
...
public class ValidationSettingsImpl implements ValidationMetaBuilder, ValidationMeta {
    ...
    public ValidationMetaBuilder baseOn(String groupName) {
        ...
        current.getValue().addAll(queryResult
                .stream()
                .map(i -> new FieldValidator(i.getField(), i.getLogic(), i.getMessage()))
